...
class Parser:
    ...
    def processCatalog(self, subtop, top, tag):
        ...
        elif subtop in ["PRODUCT_TO_CATALOGGROUP_MAP", "ARTICLE_TO_CATALOGGROUP_MAP"]:
    ...
    def processOffer(self, subtop, top, tag):
        ...
        elif subtop in ["PRODUCT_DETAILS", "ARTICLE_DETAILS"]:
        ...
        elif subtop in ["PRODUCT_ORDER_DETAILS", "ARTICLE_ORDER_DETAILS"]:
